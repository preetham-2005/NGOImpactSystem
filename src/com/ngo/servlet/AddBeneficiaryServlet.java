...
public class AddBeneficiaryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        res.sendRedirect(req.getContextPath() + "/pages/officers/add_beneficiary.jsp");
    }
        ...
        try {
            ...
            if (status) {
                res.sendRedirect(req.getContextPath() +
                        "/pages/officers/officer_dashboard.jsp?msg=success");
            } else {
                res.sendRedirect(req.getContextPath() +
                        "/pages/officers/officer_dashboard.jsp?msg=fail");
            }
